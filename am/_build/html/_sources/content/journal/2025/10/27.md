...
> Nasdaq 100 指数与经汇率调整后 Nikkei 225 指数的比值处于自 2018 年末以来的趋势线附近，比值的周 VIX FIX 处于 9.55 的位置，比值周 K 相对于 MA20 的偏移百分位处于 25.59 的位置。

> S&P 500 指数与投资级债券指数的比值，周 VIX FIX 处于 0.456 的位置，周 K 相对于 MA20 的偏移百分位处于 67.25 的位置。
...
> S&P 500 成分股收盘价分别超过 5/20/50/100/200 日均线的比例分别是 57.25/57.65/52.88/56.46/62.62。
